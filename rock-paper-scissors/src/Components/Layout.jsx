...
const Layout = ({ score }) => {
  ...
  return (
    <div className=''>
      <div className='flex flex-col bg-radial h-screen px-4'>
        ...
        <main className='mt-36'>
          ...
          <div className='absolute z-50  h-72 flex justify-center w-full '>
            <img src="../images/bg-triangle.svg" alt="" />
          </div>

          <div className='flex place-content-between -mt-14 '>
